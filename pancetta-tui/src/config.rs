...
pub struct Band {
    ...
    /// FT8 dial frequency in MHz (e.g. 14.074 for 20m)
    pub ft8_frequency: f64,
        ...
        Self {
            ...
            bands: BandConfig {
                ...
                bands: vec![
                    ...
                    Band {
                        name: "30M".to_string(),
                        frequency_range: (10.100, 10.150),
                        ft8_frequency: 10.136,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                    Band {
                        name: "20M".to_string(),
                        frequency_range: (14.000, 14.350),
                    ...
                    Band {
                        name: "17M".to_string(),
                        frequency_range: (18.068, 18.168),
                        ft8_frequency: 18.100,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                    Band {
                        name: "15M".to_string(),
                        frequency_range: (21.000, 21.450),
                        ft8_frequency: 21.074,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                    Band {
                        name: "12M".to_string(),
                        frequency_range: (24.890, 24.990),
                        ft8_frequency: 24.915,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                    Band {
                        name: "10M".to_string(),
                        frequency_range: (28.000, 29.700),
                        ft8_frequency: 28.074,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                    Band {
                        name: "6M".to_string(),
                        frequency_range: (50.000, 54.000),
                        ft8_frequency: 50.313,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                    Band {
                        name: "2M".to_string(),
                        frequency_range: (144.000, 148.000),
                        ft8_frequency: 144.174,
                        default_mode: "FT8".to_string(),
                        power_limit: None,
                    },
                ],

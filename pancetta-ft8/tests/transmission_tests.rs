...
mod transmission_tests {
    use pancetta_ft8::{
        Ft8Encoder, Ft8Modulator, Ft8Transmitter, TransmissionConfig, TransmissionState,
        FrequencyConfig, PowerConfig, AudioConfig, PttConfig, PttMethod, SafetyConfig,
        BandLimits, AudioFormat, SampleType, ModulatorConfig, Ft8EncodingConfig,
        NUM_SYMBOLS, SAMPLE_RATE, MESSAGE_DURATION
    };
...
fn test_ft8_transmission_constants() {
    use pancetta_ft8::{NUM_SYMBOLS, SAMPLE_RATE, MESSAGE_DURATION};

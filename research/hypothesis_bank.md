...
### hb-086 V2 — Joint LLR with iterative interference cancellation  [SHELVED 2026-05-30 — batch 15; **RE-EVALUATE on refreshed corpus** 2026-05-31]
  mode: ft8
  ...
  status_2026_05_31: **RE-EVALUATE.** Corpus refresh ingestion (`research/experiments/2026-05-31-corpus-refresh-ingestion.md`) replaced 100/200 hard-200 entries with today's K5ARH 20m capture. Survey (`2026-05-30-corpus-survey.md`) saw 9/20 sample slots reach jt9's -25 dB SNR floor — exactly the marginal-SNR structure V2's diagnostic showed was 0% in the OLD corpus's top-20. Re-run the V2 diagnostic on the refreshed top-20; if marginal-SNR rate ≥20%, V2 unshelves and gets a real implementation cycle.
  priority_score: 0.0  # held at 0 until re-diagnostic; flip to 0.40 if PROCEED

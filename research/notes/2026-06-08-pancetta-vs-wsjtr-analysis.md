...
- `~/Code/pancetta/Cargo.toml` — workspace structure + license
- `~/Code/pancetta/pancetta-ft8/Cargo.toml` — decoder deps
- `~/Code/pancetta/pancetta-ft8/src/decoder.rs` — 7420 LOC main decoder
- `~/Code/pancetta/pancetta-ft8/src/a7.rs` — shelved within-window A7 (hb-048)
- `~/Code/pancetta/pancetta-ft8/src/osd.rs` — OSD with neural-OSD bias hook
- `~/Code/pancetta/research/hypothesis_bank.md` — 252 hypotheses, 6400+ lines
- `~/Code/pancetta/CLAUDE.md` — architecture overview
- `~/Code/pancetta/LICENSE-MIT` — MIT half of dual license
